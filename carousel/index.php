        ...
        <!-- <div class="col-lg-8"> -->
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Carousel <span>| Today</span> <a href="add.php"><span class="badge bg-success text-white">+ Add Carousel</span></a></h5>
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <?php   // LOOP TILL END OF DATA
                      ...
                      <tr>
                        ...
                        <td><a href="#" class="text-primary"><?php echo $rows4['title1'];?></a></td>
                        <td><?php echo $rows4['titles'];?></td>
