                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <?php   // LOOP TILL END OF DATA
                      ...
                      <tr>
                        ...
                        echo $row['id_number'];
                        ?></td>
                        <td><a class="btn btn-success w-100" href="../../api/library_success.php?id=<?php echo base64_encode($rows4['id']); ?>" name="submit" type="submit">Passed</a></td>
