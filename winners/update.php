...
include '../connection/index.php';
  ...
  $query="select * from winners where id= '$id' order by id asc";
  ...
  <section class="section">
      <div class="row">
        <!-- <div class="col-lg-6"> -->
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Winner Update<span style="color: green; margin-left: 6cm;"><b><?php include('updates.php'); ?></b></span> </h5>
              ...
              <form method="POST" target="_top" autocomplete="on"   enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select   id='category' class="form-control"   name="category">
                                                <option  value="<?php echo $rows4['category'];?>" selected><?php echo $rows4['category'];?></option>
                                                <?php
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    ...
                    <option  value="<?php echo $rows4['year'];?>" selected><?php echo $rows4['year'];?></option>
                                                <?php
